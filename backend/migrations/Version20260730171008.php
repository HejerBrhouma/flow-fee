 ...
 */
final class Version20260730171008 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Initial schema: users, companies, departments, categories, expenses, expense receipts, budgets, savings goals, notifications.';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE budgets (id INT AUTO_INCREMENT NOT NULL, amount NUMERIC(10, 2) NOT NULL, currency VARCHAR(3) DEFAULT \'EUR\' NOT NULL, period VARCHAR(10) NOT NULL, year INT NOT NULL, month INT DEFAULT NULL, department_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_DCAA9548AE80F5DF (department_id), INDEX IDX_DCAA9548A76ED395 (user_id), UNIQUE INDEX uniq_budget_department_period (department_id, year, month), UNIQUE INDEX uniq_budget_user_period (user_id, year, month), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE savings_goals (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, target_amount NUMERIC(10, 2) NOT NULL, current_amount NUMERIC(10, 2) DEFAULT \'0.00\' NOT NULL, currency VARCHAR(3) DEFAULT \'EUR\' NOT NULL, target_date DATE DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, user_id INT NOT NULL, INDEX IDX_EF09AB97A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE savings_goals ADD CONSTRAINT FK_EF09AB97A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
