...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    // TOTP secret, generated by /2fa/setup and only committed once confirmed by /2fa/enable
    // (so an abandoned setup never leaves a live-but-unconfirmed secret enabled on the account).
    #[ORM\Column(length: 255, nullable: true)]
